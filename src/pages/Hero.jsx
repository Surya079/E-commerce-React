...
export const Hero = () => {
  return (
    <section className="relative bg-[url('../src/assets/shoping-hero.jpg')] bg-no-repeat bg-cover w-full bg-center h-screen ">
      <div className=" relative top-32   w-auto  ml-16 max-[400px]:top-20 max-[400px]:m-3 m-1">
        <h1 className="font-bold text-5xl   max-w-[37rem] max-[400px]:w-full max-[400px]:text-3xl">
          Welcome to Digital shoping at <b>RYGB</b>
        </h1>
        <p className="max-[400px]:text-sm m-1 max-w-[40rem] mt-10 max-[400px]:w-full max-[400px]:mt-5 text-gray-90 ">
        ...
        <div className="flex gap-x-2 max-[400px]:text-center  items-center mt-2 m-1">
        ...
        <div className="max-[400px]:flex mt-2  flex m-1">
          <NavLink className={"flex items-center bg-yellow-300 px-4 py-2 rounded-full "}>
            <MdShop /> Shop
          </NavLink>
        </div>
      </div>
